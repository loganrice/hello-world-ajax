...
var getNow = function() {
	...
	// the forma below will display to the 100th second
...
// This function makes AJAX calls to the server
var asyncDemo = function(url) {
	...
	// the done block gets executed after the ajax call return whenver that is
	.done(function(data) {
